...
const (
	TransformService_TransformStream_FullMethodName = "/avf.v1.TransformService/TransformStream"
)
...
var TransformService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "avf.v1.TransformService",
	HandlerType: (*TransformServiceServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "TransformStream",
			Handler:       _TransformService_TransformStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
	Metadata: "avf/v1/transform.proto",
}
